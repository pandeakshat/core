...
Once again, take your time. You can either choose to copy and paste this into the format that you prefer, or you can use the Notion template I’ve created, linked here. I am also working on an interactive document database that will be available later (I’ll add it to the comments once I’m done over-engineering it).
